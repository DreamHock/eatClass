...
const Home = (props) => {
    ...
    const [restaurants, setRestaurants] = useState(
        props.categories.flatMap((cat) => cat.restaurants)
    );
        ...
        const handleSearch = (e) => {
            ...
            debounceTimer = setTimeout(() => {
                if (e.detail) {
                    ...
                    // Reset to original restaurants when search is empty
                    setRestaurants(props.categories.flatMap((cat) => cat.restaurants));
                }
            }, 300);
        };
